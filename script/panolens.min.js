(function (k, d) {
    ...
    function y(a, b, c) {
        ...
        c = function (b) {
            if (this.material) {
                ...
                c.copy(this.scale);
                this.scaleUpAnimation = new m.Tween(this.scale).to({ x: 1.3 * c.x, y: 1.3 * c.y }, 500).easing(m.Easing.Elastic.Out);
    ...
    function z(a, b) {
        ...
        r.call(this);
        this.src = a;
        this.options = Object.assign({ videoElement: document.createElement('video'), loop: !0, muted: !0, autoplay: !1, playsinline: !0, crossOrigin: 'anonymous' }, b);
    ...
    function ca(a, b) {
        ...
        function g() {
            U = !0;
            H = void 0;
            !1 !== f.enabled && (document.removeEventListener('mousemove', e, !1), document.removeEventListener('mouseup', g, !1), f.dispatchEvent(S), (w = v.NONE));
        }
        function h(a) {
        ...
        this.update = function (a) {
            if (!1 !== c.enabled && c.deviceOrientation) {
                var b = c.deviceOrientation.alpha ? d.Math.degToRad(c.deviceOrientation.alpha) + c.alphaOffsetAngle : 0,
                    ...
                    x = new d.Euler(),
                    Q = new d.Quaternion(),
                    k = new d.Quaternion(-Math.sqrt(0.5), 0, 0, Math.sqrt(0.5)),
                    m = new d.Quaternion(),
                    r = new d.Quaternion();
                if (0 == c.screenOrientation) {
                    var q = new d.Vector3(1, 0, 0);
                    m.setFromAxisAngle(q, -g);
                } else 180 == c.screenOrientation ? ((q = new d.Vector3(1, 0, 0)), m.setFromAxisAngle(q, g)) : 90 == c.screenOrientation ? ((q = new d.Vector3(0, 1, 0)), m.setFromAxisAngle(q, g)) : -90 == c.screenOrientation && ((q = new d.Vector3(0, 1, 0)), m.setFromAxisAngle(q, -g));
                k.multiply(m);
                k.multiply(r);
                x.set(h, b, -f, 'YXZ');
                n.setFromEuler(x);
    ...
    function ia(a) {
        ...
        e.aspect = 0.5;
        var g = new d.WebGLRenderTarget(512, 512, { minFilter: d.LinearFilter, magFilter: d.NearestFilter, format: d.RGBAFormat });
        g.scissorTest = !0;
        g.texture.generateMipmaps = !1;
        var h = new d.Vector2(0.441, 0.156),
    ...
    function ea(a) {
        ...
        this.handlerTap = this.onTap.bind(this, { clientX: D / 2, clientY: r / 2 });
    ...
    var ja = '^0.105.2'.replace(/[^0-9.]/g, ''),
        ...
        fa = {
            load: function (a, b, c, e) {
                ...
                if (0 === a.indexOf('data:')) return m.addEventListener('load', f, !1), (m.src = a), m;
        ...
        updateUniformByFormat: function (a, b) {
            ...
            switch (a) {
                case C.TAB:
                    ...
                    break;
                case C.SBS:
                    c.set(0.5, 1), b.set(0, 0), e.set(0, 0), g.set(0.5, 0);
            }
        },
    ...
    var m = (function (a, b) {
            ...
            update: function (a) {
                ...
                if (1 === e)
                    if (0 < this._repeat) {
                        ...
                        for (b in this._valuesStartRepeat) 'string' === typeof this._valuesEnd[b] && (this._valuesStartRepeat[b] += parseFloat(this._valuesEnd[b])), this._yoyo && ((e = this._valuesStartRepeat[b]), (this._valuesStartRepeat[b] = this._valuesEnd[b]), (this._valuesEnd[b] = e)), (this._valuesStart[b] = this._valuesStartRepeat[b]);
        ...
        c.Interpolation = {
            ...
            CatmullRom: function (a, b) {
                ...
                return a[0] === a[e] ? (0 > b && (d = Math.floor((g = e * (1 + b)))), l(a[(d - 1 + e) % e], a[d], a[(d + 1) % e], a[(d + 2) % e], g - d)) : 0 > b ? a[0] - (l(a[0], a[0], a[1], a[1], -g) - a[0]) : 1 < b ? a[e] - (l(a[e], a[e], a[e - 1], a[e - 1], g - e) - a[e]) : l(a[d ? d - 1 : 0], a[d], a[e < d + 1 ? e : d + 1], a[e < d + 2 ? e : d + 2], g - d);
            },
            Utils: {
    ...
    y.prototype = Object.assign(Object.create(d.Sprite.prototype), {
        ...
        onDualEyeEffect: function (a) {
            if (this.getContainer()) {
                ...
                a && (a.left || a.right || ((a.left = a.cloneNode(!0)), (a.right = a.cloneNode(!0))), this.mode === q.CARDBOARD || this.mode === q.STEREO ? ((a.left.style.display = a.style.display), (a.right.style.display = a.style.display), (a.style.display = 'none')) : ((a.style.display = a.left.style.display), (a.left.style.display = 'none'), (a.right.style.display = 'none')), this.translateElement(b, c), this.container.appendChild(a.left), this.container.appendChild(a.right));
            }
        },
        translateElement: function (a, b) {
            if (this.element._width && this.element._height && this.getContainer()) {
                ...
                var n = a - g;
                var l = b - d - p;
                (this.mode !== q.CARDBOARD && this.mode !== q.STEREO) || !e.left || !e.right || (a === c.clientWidth / 2 && b === c.clientHeight / 2) ? this.setElementStyle('transform', e, 'translate(' + n + 'px, ' + l + 'px)') : ((n = c.clientWidth / 4 - g + (a - c.clientWidth / 2)), (l = c.clientHeight / 2 - d - p + (b - c.clientHeight / 2)), this.setElementStyle('transform', e.left, 'translate(' + n + 'px, ' + l + 'px)'), (n += c.clientWidth / 2), this.setElementStyle('transform', e.right, 'translate(' + n + 'px, ' + l + 'px)'));
            }
        },
    ...
    L.prototype = Object.assign(Object.create(d.EventDispatcher.prototype), {
        ...
        createDefaultMenu: function () {
            var a = this,
                b = function (b, e) {
                    return function () {
                        a.dispatchEvent({ type: 'panolens-viewer-handler', method: b, data: e });
                    };
                };
            return [
                {
                ...
                },
                {
                    ...
                    subMenu: [
                        ...
                        { title: 'Cardboard', handler: b('enableEffect', q.CARDBOARD) },
        ...
        createSettingButton: function () {
            ...
            var b = this.createCustomItem({
                style: { backgroundImage: 'url("' + t.Setting + '")', webkitTransition: this.DEFAULT_TRANSITION, transition: this.DEFAULT_TRANSITION },
                onTap: function (b) {
                    b.preventDefault();
                    b.stopPropagation();
                    a.mainMenu.toggle();
        ...
        createFullscreenButton: function () {
            ...
            if (document.fullscreenEnabled || document.webkitFullscreenEnabled || document.mozFullScreenEnabled || document.msFullscreenEnabled) {
                ...
                var d = this.createCustomItem({
                    style: { backgroundImage: 'url("' + t.FullscreenEnter + '")' },
                    onTap: function (a) {
                        a.preventDefault();
                        a.stopPropagation();
                        e = !1;
                        c ? (document.exitFullscreen && document.exitFullscreen(), document.msExitFullscreen && document.msExitFullscreen(), document.mozCancelFullScreen && document.mozCancelFullScreen(), document.webkitExitFullscreen && document.webkitExitFullscreen(), (c = !1)) : (g.requestFullscreen && g.requestFullscreen(), g.msRequestFullscreen && g.msRequestFullscreen(), g.mozRequestFullScreen && g.mozRequestFullScreen(), g.webkitRequestFullscreen && g.webkitRequestFullscreen(Element.ALLOW_KEYBOARD_INPUT), (c = !0));
        ...
        createVideoControlButton: function () {
            var a = this,
                b = this.createCustomItem({
                    style: { float: 'left', backgroundImage: 'url("' + t.VideoPlay + '")' },
                    onTap: function (c) {
                        c.preventDefault();
                        c.stopPropagation();
        ...
        createVideoControlSeekbar: function () {
            ...
            function b(a) {
                d && ((l = ((a.clientX || (a.changedTouches && a.changedTouches[0].clientX)) - p) / f.clientWidth), (l = n + l), (l = 1 < l ? 1 : 0 > l ? 0 : l), f.setProgress(l), g.dispatchEvent({ type: 'panolens-viewer-handler', method: 'setVideoCurrentTime', data: l }));
            }
            function c(a) {
                a.stopPropagation();
                d = !1;
            ...
            m.addEventListener('touchstart', a, { passive: !0 });
            k.appendChild(m);
        ...
        createSubMenu: function (a, b) {
            ...
            h.addHeader(a)
                .addIcon(void 0, !0, !0)
                .addEventListener(e.TOUCH_ENABLED ? 'touchend' : 'click', c, !1);
    ...
    var ka = { tEquirect: { value: new d.Texture() }, repeat: { value: new d.Vector2(1, 1) }, offset: { value: new d.Vector2(0, 0) }, opacity: { value: 1 } };
    r.prototype = Object.assign(Object.create(d.Mesh.prototype), {
        ...
        add: function (a) {
            ...
            a instanceof y &&
                ((b = this.container) && a.dispatchEvent({ type: 'panolens-container', container: b }),
                a.dispatchEvent({
        ...
        setupTransitions: function () {
            this.fadeInAnimation = new m.Tween(this.material).easing(m.Easing.Quartic.Out).onStart(
                function () {
                    this.visible = !0;
                    this.dispatchEvent({ type: 'enter-fade-start' });
                }.bind(this)
            );
            this.fadeOutAnimation = new m.Tween(this.material).easing(m.Easing.Quartic.Out).onComplete(
                function () {
                    this.visible = !1;
                    this.dispatchEvent({ type: 'leave-complete' });
                }.bind(this)
            );
            this.enterTransition = new m.Tween(this)
                .easing(m.Easing.Quartic.Out)
                .onComplete(
                    function () {
        ...
        dispose: function () {
            function a(b) {
                for (var c = b.geometry, d = b.material, h = b.children.length - 1; 0 <= h; h--) a(b.children[h]), b.remove(b.children[h]);
    ...
    M.prototype = Object.assign(Object.create(r.prototype), {
        ...
        createMaterial: function () {
            ...
            a.opacity.value = 0;
            return new d.ShaderMaterial({ fragmentShader: b, vertexShader: c, uniforms: a, side: d.BackSide, transparent: !0, opacity: 0 });
        },
        load: function () {
    ...
    z.prototype = Object.assign(Object.create(r.prototype), {
        ...
        load: function () {
            ...
            d = function () {
                ...
                this.isMobile() && (h.pause(), e && b ? this.dispatchEvent({ type: 'panolens-viewer-handler', method: 'updateVideoPlayButton', data: !1 }) : this.dispatchEvent({ type: 'panolens-viewer-handler', method: 'updateVideoPlayButton', data: !0 }));
                window.requestAnimationFrame(function () {
                    k({ loaded: 1, total: 1 });
                    m(a);
                });
        ...
        setVideoTexture: function (a) {
            if (a) return (a = new d.VideoTexture(a)), (a.minFilter = d.LinearFilter), (a.magFilter = d.LinearFilter), (a.format = d.RGBFormat), this.updateTexture(a), a;
        },
        reset: function () {
        ...
        resumeVideoProgress: function () {
            var a = this.videoElement;
            4 <= a.readyState && a.autoplay && !this.isMobile() ? (this.playVideo(), this.dispatchEvent({ type: 'panolens-viewer-handler', method: 'updateVideoPlayButton', data: !1 })) : (this.pauseVideo(), this.dispatchEvent({ type: 'panolens-viewer-handler', method: 'updateVideoPlayButton', data: !0 }));
    ...
    Object.assign(Z.prototype, {
        ...
        composePanorama: function () {
            ...
            for (var e = this._parameters.useWebGL, d = 0; d < b; d++)
                for (var h = {}, k = 0; k < a; h = { $jscomp$loop$prop$url$2: h.$jscomp$loop$prop$url$2 }, k++)
    ...
    var la = { tDiffuse: { value: new d.Texture() }, resolution: { value: 1 }, transform: { value: new d.Matrix4() }, zoom: { value: 1 }, opacity: { value: 1 } };
    B.prototype = Object.assign(Object.create(u.prototype), {
        ...
        createGeometry: function (a) {
            return new d.PlaneBufferGeometry(a, 0.5 * a);
        },
        ...
        onMouseMove: function (a) {
            switch ((a.touches && a.touches.length) || 1) {
                case 1:
                    var b = 0 <= a.clientX ? a.clientX : a.touches[0].clientX;
                    a = 0 <= a.clientY ? a.clientY : a.touches[0].clientY;
                    var c = 0.4 * d.Math.degToRad(b - this.userMouse.x),
                        e = 0.4 * d.Math.degToRad(a - this.userMouse.y);
    ...
    ca.prototype = Object.assign(Object.create(d.EventDispatcher.prototype), { constructor: ca });
    ...
    ea.prototype = Object.assign(Object.create(d.EventDispatcher.prototype), {
        ...
        add: function (a) {
            ...
            a instanceof r && a.dispatchEvent && a.dispatchEvent({ type: 'panolens-container', container: this.container });
        ...
        disableEffect: function () {
            this.mode !== q.NORMAL && ((this.mode = q.NORMAL), this.disableReticleControl(), this.activateWidgetItem(void 0, this.mode), this.dispatchEventToChildren({ type: 'panolens-dual-eye-effect', mode: this.mode }), this.renderer.setSize(this.container.clientWidth, this.container.clientHeight), this.render(), this.dispatchEvent({ type: 'mode-change', mode: this.mode }));
        },
        ...
        tweenControlCenter: function (a, b, c) {
            ...
            this.tweenLeftAnimation = new m.Tween(k)
                .to({ left: a }, b)
                .easing(c)
                .onUpdate(function (a) {
                    d(a.left - n);
                ...
                .start();
            this.tweenUpAnimation = new m.Tween(k)
                .to({ up: e }, b)
                .easing(c)
                .onUpdate(function (a) {
                    h(a.up - l);
        ...
        onTap: function (a, b) {
            ...
            if (this.panorama) {
                ...
                'mouseup' === this.userMouse.type && (d && this.pressEntityObject === d && this.pressEntityObject.dispatchEvent && this.pressEntityObject.dispatchEvent({ type: 'pressstop-entity', mouseEvent: a }), (this.pressEntityObject = void 0));
                'mouseup' === this.userMouse.type && (g && this.pressObject === g && this.pressObject.dispatchEvent && this.pressObject.dispatchEvent({ type: 'pressstop', mouseEvent: a }), (this.pressObject = void 0));
                if ('click' === b) this.panorama.dispatchEvent({ type: 'click', intersects: c, mouseEvent: a }), d && d.dispatchEvent && d.dispatchEvent({ type: 'click-entity', mouseEvent: a }), g && g.dispatchEvent && g.dispatchEvent({ type: 'click', mouseEvent: a });
                else {
                    ...
                    !g && this.pressObject && this.pressObject.dispatchEvent && (this.pressObject.dispatchEvent({ type: 'pressstop', mouseEvent: a }), (this.pressObject = void 0));
                }
                if (g && g instanceof y) {
